...
var SubClean = /** @class */ (function () {
     ...
     * @returns IArguments
     */
    SubClean.prototype.cleanFile = function (item, raw) {
        var _this = this;
        return new Promise(function (done, reject) {
            try {
                // Parse the subtitle file
                var fileData = raw || fs_1.readFileSync(item.input, 'utf-8');
                // Remove all cases of \r (parser can not handle these)
                fileData = fileData.replace(/\r/g, ' ');
                var nodes_1 = subtitle_1.parseSync(fileData);
                var hits_1 = 0;
                // For debugging
                _this.nodes_count += nodes_1.length;
                // To avoid duplicates
                var codes = [];
                for (var _i = 0, _a = item.lang.split(','); _i < _a.length; _i++) {
                    var c = _a[_i];
                ...
                if (codes.length > 0) {
                    if (_this.args.debug)
                        _this.log('[Info] Attempting to load language filters: ' + codes.join(','));
                    for (var _b = 0, codes_1 = codes; _b < codes_1.length; _b++) {
                        var code = codes_1[_b];
                        var filter = code + "-main.json";
                        _this.loadBlacklist(filter);
                    }
                }
                // Remove ads
                ...
                var cleaned = subtitle_1.stringifySync(nodes_1, { format: item.ext });
                // Write cleaned file
                if (_this.args.testing === false) {
                    _this.saveFile(cleaned, item.output, true);
                }
                if (hits_1 > 0)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                        var $app, $filters, queue, dedupe, files, _i, files_2, file, codes, _a, _b, c, _c, codes_2, c, _d, queue_1, file, result, error_2;
    ...
    SubClean.prototype.module = function (raw) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.ensureDirs();
                // Load the blacklist
                ...
                this.args.ne = true;
                return [2 /*return*/, this.cleanFile(this.args, raw)];
            });
        });
    };
    return SubClean;
